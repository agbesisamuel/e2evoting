...
DEFAULT_FROM_EMAIL = get_from_env('DEFAULT_FROM_EMAIL', 'agbesisamuel@gmail.com')
DEFAULT_FROM_NAME = get_from_env('DEFAULT_FROM_NAME', 'Samuel for COMET')
...
# election stuff
SITE_TITLE = get_from_env('SITE_TITLE', 'COMET Voting')
...
HELP_EMAIL_ADDRESS = get_from_env('HELP_EMAIL_ADDRESS', 'agbesisamuel@gmail.com')
...
EMAIL_HOST ='smtp.gmail.com' # get_from_env('EMAIL_HOST', 'localhost')
EMAIL_PORT =587 # int(get_from_env('EMAIL_PORT', "2525"))
